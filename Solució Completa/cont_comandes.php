...
<body>
    ...
    if ($resultado->num_rows > 0) {
        echo "<table>";
        echo "<tr><th>Comanda</th><th>Comprador</th><th>Empresa</th><th>Incidencia</th><th>Productes</th><th>Data Comanda</th></tr>";
        ...
        while ($fila = $resultado->fetch_assoc()) {
            ...
            echo "<input type='hidden' name='id_comanda' value='" . $fila['idcoman'] . "'>";
            echo "<button type='submit' class='btnAvis'>Veure</button>";
            echo "</form></td>";
