...
$sqlConsultaDomicilio = "SELECT carrer, numero, pis, porta, domicili.codiPostal, poblacio.nom AS poblacio, poblacio.nomZona AS zona
                        FROM domicili
...
<head>
    ...
    <title>Elegir del Domicili</title>  <!-- titol de la pàgina -->
...
<body>
    ...
    <div class="container">
        ...
        <form action="../comprador.php" method="post">
            <button type="submit" class="otro-archivo-btn">CONFIRMAR</button>
        </form>
    </div>
